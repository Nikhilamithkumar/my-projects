      ...
      {weatherData && weatherData.main && weatherData.weather && (
        <>
          <div className={styles.header}>
            ...
            <p className={styles.condition}>{weatherData.weather[0].main}</p>
          </div>
          <div className={styles['weather-details']}>
            <div className={styles['weather-detail-container']}>
              <p >Humidity</p>
      ...
      {forecast.length > 0 &&(
        <>
          <div className={styles.forecast}>
            <h2 className={styles['forecast-header']}>5-Day Forecast</h2>
